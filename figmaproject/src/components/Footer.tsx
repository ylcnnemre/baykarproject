            ...
            <div className="cursor-pointer self-stretch h-[46px] flex flex-col sm:items-start items-center justify-center text-[8.38px] text-default-white font-open-sans">
              <div className="relative w-[135px] h-10">
                <img
                  ...
                  src="/vector1.svg"
                />
                <div className="absolute top-[11.55%] left-[30.37%] [-webkit-text-stroke:0.2px_#fff]">
                  GET IT ON
                </div>
                <img
                  className="absolute h-[42.39%] w-[62.92%] top-[42.61%] right-[6.8%] bottom-[15%] left-[30.28%] max-w-full overflow-hidden max-h-full"
                  alt=""
                  src="/vector2.svg"
                />
                <img
                  className="absolute h-[33.58%] w-[12.03%] top-[48.55%] right-[80.51%] bottom-[17.87%] left-[7.46%] max-w-full overflow-hidden max-h-full"
                  alt=""
                  src="/vector3.svg"
                />
                <img
                  className="absolute h-[27.6%] w-[9.26%] top-[36.25%] right-[75.56%] bottom-[36.15%] left-[15.18%] max-w-full overflow-hidden max-h-full"
                  alt=""
                  src="/vector4.svg"
                />
                <img
                  className="absolute h-[53.65%] w-[8.22%] top-[23.2%] right-[84.37%] bottom-[23.15%] left-[7.41%] max-w-full overflow-hidden max-h-full"
                  alt=""
                  src="/vector5.svg"
                />
                <img
                  className="absolute h-[32.15%] w-[12.05%] top-[17.85%] right-[80.51%] bottom-[50%] left-[7.44%] max-w-full overflow-hidden max-h-full"
                  alt=""
                  src="/vector6.svg"
                />
              </div>
